export default {
  ...
  // Environmental - Subsidence Monitoring
  'pages.environmental.subsidence.title': 'Geological Subsidence Monitoring',
  'pages.environmental.subsidence.description': '3D visualization of ground subsidence data',
  'pages.environmental.subsidence.scene.global': 'Global View',
  'pages.environmental.subsidence.scene.china': 'China View',
  'pages.environmental.subsidence.scene.beijing': 'Beijing Area',
  'pages.environmental.subsidence.scene.local': 'Local Monitoring',
  'pages.environmental.subsidence.layers.terrain': 'Terrain',
  'pages.environmental.subsidence.layers.imagery': 'Satellite Imagery',
  'pages.environmental.subsidence.layers.subsidence': 'Subsidence Data',
};
