export default {
  ...
  // 环境监测 - 沉降监测
  'pages.environmental.subsidence.title': '地质沉降监测',
  'pages.environmental.subsidence.description': '地面沉降数据三维可视化',
  'pages.environmental.subsidence.scene.global': '全球视图',
  'pages.environmental.subsidence.scene.china': '中国视图',
  'pages.environmental.subsidence.scene.beijing': '北京区域',
  'pages.environmental.subsidence.scene.local': '本地监测',
  'pages.environmental.subsidence.layers.terrain': '地形',
  'pages.environmental.subsidence.layers.imagery': '卫星影像',
  'pages.environmental.subsidence.layers.subsidence': '沉降数据',
};
